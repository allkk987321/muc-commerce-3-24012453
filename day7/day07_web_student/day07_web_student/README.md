...
- 学号：24012453
- 专题方向：A（用户生命周期）
- 已完成功能：4张指标卡、2张真实图表、偏好品类筛选、4类离线规则问答
- 选择的拓展任务：C. Flask自动化测试
- 拓展访问或运行方法：`pip install -r requirements.txt && cd tests && pytest test_routes.py -v`
- 拓展证据文件：tests/test_routes.py、test_result.txt
- 尚未解决的问题：无
